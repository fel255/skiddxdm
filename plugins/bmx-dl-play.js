...
let handler = async (m, { conn, text, botname }) => {
  ...
  await m.reply("🔄 *Siddxdm bot Fetching your audio... Please wait...*");
        ...
        if (data.status === 200 || data.success) {
          ...
          await conn.sendMessage(
            m.chat,
            {
              ...
              caption: `FELICIAN THE SKIDDBMX BOT
╭═════════════════⊷
║ 🎶 *Title:* ${songData.title}
║ 🎤 *Artist:* ${songData.artist}
║ 🔗 THANK YOU SORRY NO URL TO BE SHARED
╰═════════════════⊷
*Powered by FELICIAN BOT*`
            },
            { quoted: m }
          );
          ...
          await m.reply("✅ *SKIDDXMD – World-class bot just successfully sent you what you requested! 🎶*");
